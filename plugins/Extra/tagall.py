...
async def mentionall(client, message):
    ...
    if message.chat.type == ChatType.PRIVATE:
        return await message.reply("This commands only for group.")
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("You Are Not Admin, Only Admins Can. ")
...
async def cancel_spam(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("You Are Not Admin, Only Admins Can Tag Members.")
    else:
        try:
